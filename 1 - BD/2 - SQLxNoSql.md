...
D - Durabilidade (Durability): Uma vez que a transação foi confirmada (commit), o dado está salvo de forma permanente (em disco), mesmo que falte energia no servidor um milissegundo depois.
